...
const TalentSignUp = async (req, res, next) => {
    try {
        ...
        const payload = {
            ...
            birthday_rate_per_day: isNaN(req.body.birthday_rate_per_day) ? 0 : req.body.birthday_rate_per_day ||  0,
            debut_rate_per_day:  isNaN(req.body.debut_rate_per_day) ? 0 : req.body.debut_rate_per_day ||  0,
            wedding_rate_per_day:  isNaN(req.body.wedding_rate_per_day) ? 0 : req.body.wedding_rate_per_day ||  0,
            baptismal_rate_per_day: isNaN(req.body.baptismal_rate_per_day) ? 0 : req.body.baptismal_rate_per_day ||  0,
            seminar_rate_per_day: isNaN(req.body.seminar_rate_per_day) ? 0 : req.body.seminar_rate_per_day ||  0,
            company_party_rate_per_day:  isNaN(req.body.company_party_rate_per_day) ? 0 : req.body.company_party_rate_per_day ||  0,
            school_event_rate_per_day:isNaN(req.body.school_event_rate_per_day) ? 0 : req.body.school_event_rate_per_day ||  0,
